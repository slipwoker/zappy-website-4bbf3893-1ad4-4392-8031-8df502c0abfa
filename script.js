    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Earasers משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '4bbf3893-1ad4-4392-8031-8df502c0abfa',
                    name: data.name || '',
                    email: data.email || '',
